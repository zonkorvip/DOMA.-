...
import { Activity, Mail, Lock, User, ChevronLeft, Loader2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#020617] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-bold">انضم لمستقبل التمريض</h1>
          <p className="text-slate-400 mt-2">ابدأ رحلتك التعليمية المتقدمة اليوم</p>
        </div>
        ...
        <div className="glass-card p-8 rounded-3xl">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-[10px] text-slate-500">يجب أن تكون 6 أحرف على الأقل</p>
            </div>
          ...
          <div className="mt-8 text-center text-sm text-slate-400">
            لديك حساب بالفعل؟{' '}
            <Link to="/login" className="text-teal-400 font-bold hover:underline">سجل دخولك</Link>
          </div>
        </div>
      </motion.div>
    </div>
